...
{
    //
	public function __construct(){ // Trang chủ và trang liên hệ đều cần dữ liệu của thanh menu và slide để hiển thị ra, dùng view share để cả 2 trang đều có biến này để sử dụng.
		$data = [
			'theloai' => TheLoai::all(),
			'slide' => Slide::all()
		];
    ...
    {
    	// Validator khi dùng if để kiểm tra lỗi dữ liệu đầu vào trước khi kiểm tra đăng nhập (#Manually Creating Validators tại trang chủ Laravel)
