...
$id=$tintuc->id.'';
if(!isset($_COOKIE[$id])){
    setcookie($id,1,time()+1200000);
}
else{
    $currentCount=++$_COOKIE[$id];
    setcookie($id,$currentCount,time()+1200000);
}
?>
...
<div class="container">
	<div class="row">
		...
		<div class="col-lg-9">
			...
			<!-- Author -->
			<p class="lead">
				by <a href="lien-he">Admin</a>
				<p><img class="img-fluid" src="upload/view.jpg" style="width:20px;" alt="">Lượt xem: 
